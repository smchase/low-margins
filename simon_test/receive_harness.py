...
if __name__ == "__main__":
    ...
    print("\n" + "="*60)
    print("Press SPACE to start reception (will sync to even second)")
    print("="*60)
    ...
    # Wait for the next even second boundary (same logic as transmitter)
    ...
    print(f"GO! Starting reception at t={start_time:.3f}")
